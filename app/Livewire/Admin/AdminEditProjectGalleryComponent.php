...
class AdminEditProjectGalleryComponent extends Component
{
    use WithFileUploads;
    use ToastTrait;
    public $gallery;
    ...
    {
        $this->gallery = \App\Models\ProjectGallery::find($id);
        if (! $this->gallery) {
    ...
    public function updateGallery()
    {
        ...
        try {
            ...
            if ($this->newImage) {
                ...
                $this->newImage->storeAs('assets/projects/gallery', $image);
                $this->gallery->image = $image ?? $this->gallery->image;
            }
    ...
    {
        return view('livewire.admin.admin-edit-project-gallery-component');
    }
}

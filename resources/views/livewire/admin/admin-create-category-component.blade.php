    ...
    <div class="max-w-7xl mx-auto">
        <div class="bg-green-50 dark:glass-effect rounded-2xl p-6 mb-6">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div>
                    <h1 class="text-3xl font-bold gradient-text-animated mb-2">Create New Category</h1>
        ...
        <div class="grid grid-cols-1 gap-6 mb-8">
            <form wire:submit.prevent="createCat" enctype="multipart/form-data">
            <div class="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-2">
                ...
                <flux:input type="text" label="Category Slug(Auto)" wire:model="slug" />
            </div>
            <div class="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-2">
                <flux:input type="file" label="Category Image" wire:model.live="image" />
                @if($image)
            ...
            <div class="flex justify-end my-2">
                <flux:button type="submit" variant="primary">Create New Category</flux:button>
            </div>
            </form>

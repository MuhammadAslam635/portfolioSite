                ...
                <div class="flex flex-row items-center gap-3">
                    <div class="bg-gray-900 dark:bg-green-600 px-4 py-2 rounded-lg border border-green-700">
                        <span class="text-sm text-gray-300">Total: <span
                                class="text-neon-green font-semibold">{{ $totalCats }}</span>
                            Catgeories</span>
                    </div>
            ...
            @foreach ($cats as $cat)
                <div
                    ...
                    <div class="absolute top-4 left-4 z-10">
                        <div class="grid grid-cols-3 gap-3">
                            <span
                                ...
                                {{ $cat->is_active ? '⭐ Active' : 'In-Active' }}
                            </span>
                            <a href="{{ route('categories.edit', ['slug' => $cat->slug]) }}" wire:navigate>
                                <span
                    ...
                    <div class="relative h-48 overflow-hidden">
                        <img src="{{ asset($cat->image) }}" alt="Blog Image"
            ...
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div class="text-sm text-gray-800 dark:text-green-600">
                    Showing <span class="font-semibold text-neon-green">1</span> to <span
                        class="font-semibold text-neon-green">{{ $cats->count() }}</span> of <span
                        class="font-semibold text-neon-green">{{ $totalCats }}</span> results
                </div>

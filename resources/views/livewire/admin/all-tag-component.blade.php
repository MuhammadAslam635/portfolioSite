    ...
    <div class="max-w-7xl mx-auto">
        <div class="bg-green-50 dark:bg-black rounded-2xl p-6 mb-6">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div>
                    <h1 class="text-3xl font-bold gradient-text-animated mb-2">All Tags</h1>
                ...
                <div class="flex flex-row items-center gap-3">
                    <div class="bg-gray-900 dark:bg-green-600 px-4 py-2 rounded-lg border border-green-700">
                        <span class="text-sm text-gray-300">Total: <span
                                class="text-neon-green font-semibold">{{ $totalTags }}</span>
                            Tags</span>
                    </div>
            ...
            @foreach ($tags as $tag)
                <div
                    ...
                    <div class="absolute top-4 left-4 z-10">
                        <div class="grid grid-cols-3 gap-3">
                            <span
                                ...
                                {{ $tag->is_active ? '⭐ Active' : 'In-Active' }}
                            </span>
                            <a href="{{ route('tags.edit', ['slug' => $tag->slug]) }}" wire:navigate>
                                <span
                    ...
                    <div class="relative h-48 overflow-hidden">
                        <img src="{{ asset($tag->image) }}" alt="Blog Image"
            ...
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div class="text-sm text-gray-800 dark:text-green-600">
                    Showing <span class="font-semibold text-neon-green">1</span> to <span
                        class="font-semibold text-neon-green">{{ $tags->count() }}</span> of <span
                        class="font-semibold text-neon-green">{{ $totalTags }}</span> results
                </div>

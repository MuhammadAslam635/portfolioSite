    ...
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            ...
            <flux:navlist.group :heading="__('Categories')" class="grid">
                <flux:navlist.item icon="list-todo" :href="route('categories')"
            ...
            <flux:navlist.group :heading="__('Tags')" class="grid">
                <flux:navlist.item icon="tag" :href="route('tags')" :current="request()->routeIs('tags')"
                    wire:navigate>{{ __('Tags') }}</flux:navlist.item>
            </flux:navlist.group>
            <flux:navlist.group :heading="__('Skills')" class="grid">
                <flux:navlist.item icon="file-code" :href="route('skills.index')"
                    :current="request()->routeIs('skills.index')" wire:navigate>{{ __('Skills') }}</flux:navlist.item>
            </flux:navlist.group>
            ...
            <flux:navlist.group :heading="__('Team')" class="grid">
                <flux:navlist.item icon="users" :href="route('team.index')"
                    :current="request()->routeIs('team.index')" wire:navigate>{{ __('Team') }}</flux:navlist.item>
            </flux:navlist.group>
        </flux:navlist>
                    ...
                    <div class="p-0 text-sm font-normal">
                        <div class="flex items-center gap-2 px-1 py-1.5 text-start text-sm">
                            <span class="relative flex h-8 w-8 shrink-0 overflow-hidden rounded-lg">
                                <span
                                    class="flex h-full w-full items-center justify-center rounded-lg bg-neutral-200 text-neon-green dark:bg-neutral-700 dark:text-white">
                                    {{ auth()->user()->initials() }}
                                </span>
                            </span>

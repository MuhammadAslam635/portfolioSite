    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="hero-content">
            <h1 class="text-6xl md:text-8xl font-bold mb-6 font-mono hero-title">
                <span class="gradient-text-animated">CODE HIGH</span>
                <br>
                <span class="text-white">SOFTWARE HOUSE</span>
            </h1>
            <div class="text-xl md:text-2xl mb-8 font-mono text-gray-300 hero-subtitle">
                <span class="text-red-500">{'<>'}</span> <span class="typewriter-text">Web & App Development</span>
            ...
            <p class="text-lg md:text-xl mb-12 max-w-3xl mx-auto leading-relaxed hero-description">
                Architecting robust app and scalable APIs with modern technologies.
                Specializing in NestJS, Golang, FastAPI, Laravel, Flutter, React, Angular and cloud infrastructure.
            </p>
            <div class="flex flex-col sm:flex-row gap-6 justify-center items-center hero-buttons">
                ...
                <button
                    class="magnetic-button border-2 border-neon-green text-neon-green px-8 py-4 rounded-lg font-semibold hover:bg-neon-green hover:text-neon-green transition-all duration-300">
                    Get Quote
                </button>
            </div>
        </div>
